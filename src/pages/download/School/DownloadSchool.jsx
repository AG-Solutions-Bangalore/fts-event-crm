      ...
      <div className="  bg-[#FFFFFF] p-2   rounded-lg">
        ...
        <form id="dowRecp" autoComplete="off">
          ...
          <div className="flex justify-start py-4">
            <button
              className="text-center text-sm font-[400] cursor-pointer hover:animate-pulse w-56 text-white bg-blue-600 hover:bg-green-700 p-2 rounded-lg shadow-md mr-2"
              onClick={onSubmit}
