  ...
  return (
    <div className=" flex justify-center">
      <div className="p-6 mt-5 bg-white shadow-md rounded-lg md:w-[86%]">
        ...
        <div ref={componentRef} className="p-2" style={{ margin: "5px" }}>
          ...
          <div className="text-justify md:mx-20 mt-[10px] ">
            <div className="md:text-xs text-[9px] space-y-1">
              <div className="flex text-[0.6rem] justify-between">
                <span>
                ...
                <>
                  ...
                  {receipts.individual_company.indicomp_res_reg_address && (
                    <div className="space-y-1 text-[#464D69] text-xl">
                      ...
                      <p>{receipts.individual_company.indicomp_res_reg_area}</p>
                      <p>
            ...
            {receipts.receipt_donation_type === "One Teacher School" && (
              <>
                ...
                <p>
                  ...
                  {receipts.receipt_total_amount}/- Rupees {amountInWords} Only
                  vide{" "}
                ...
                <p>
                  ...
                  support towards the need of our tribals and also the efforts
                  being made by our Society for achieving comprehensive
                  development of our tribal brethren particularly the literacy
                  of their children and health & economic welfare.
                </p>
              </>
            )}
